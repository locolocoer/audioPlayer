  ...
  return (
    <div className="player-bar">
      ...
      <div className="player-bar-end">
        ...
        >
          <svg viewBox="0 0 24 24" width="15" height="15" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round"><path d="M3 12h18"/><path d="M6 17c2 0 2-5 5-5s3 5 5 5"/><path d="M6 7c2 0 2 5 5 5s3-5 5-5"/></svg>
        </button>
      </div>
    </div>
  )
